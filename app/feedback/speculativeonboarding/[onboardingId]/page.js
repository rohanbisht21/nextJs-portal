  ...
  const nestedCategories = [
    {
      ...
      label: '',
      subCategories: [
        { name: 'Topic1', label: 'The ease and seamlessness of the move-in process' },
        { name: 'Topic2', label: 'Your level of satisfaction with our space design and ambience' },
        { name: 'Topic3', label: 'Your satisfaction with our overall service' },
      ],
    },
      ...
      <div className={`${styles.container} ${sfui_regular.className}`}>
        <div className={`${styles.whole} ${styles.left} ${styles.bottomContainer} ${styles.feedbackForm}`}>
          <div className={`${styles.whole} ${styles.left}  ${styles.pc}`}>
            ...
            Please share your onboarding experience on the below parameters on a scale of 1 to 10 with 10 being the highest.
            </h3>
